  ...
  return (
    <SectionContainer darkSurface={false} borderBottom={false}>
      <div className="border border-brand-orange bg-surface-card p-8 sm:p-14 text-center max-w-5xl mx-auto space-y-6">
        <div className="inline-flex items-center gap-2 border border-brand-orange/40 bg-background px-4 py-1 rounded-sm text-xs uppercase tracking-wider font-semibold text-brand-orange">
        ...
        <div className="pt-4 flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-2 border border-surface-border bg-background px-8 py-4 rounded-md text-xs font-semibold uppercase tracking-widest text-text-primary hover:border-brand-orange hover:text-brand-orange transition-colors"
          >
