  ...
  return (
    <footer className="border-t border-surface-border bg-background text-text-secondary">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-12">
          ...
          <div className="space-y-4 lg:col-span-5">
            ...
            <p className="text-sm text-text-secondary max-w-md">
              Digital Transformation | Software Development | Technology &amp; IT Services
            </p>
            <p className="text-xs uppercase tracking-label text-brand-orange font-semibold">
          ...
          <div className="space-y-3 lg:col-span-3">
            <h4 className="text-xs font-semibold uppercase tracking-label text-text-primary">
              Navigation
            </h4>
          ...
          <div className="space-y-3 lg:col-span-4">
            ...
            <ul className="space-y-2.5 text-sm">
              <li className="flex items-center gap-2">
                ...
                <span className="text-xs text-text-secondary">General:</span>
                <a
              ...
              <li className="flex items-center gap-2">
                <Mail className="h-4 w-4 text-brand-orange" />
                <span className="text-xs text-text-secondary">Javed A. Qureshi (Founder):</span>
                <a
              ...
              <li className="flex items-center gap-2">
                <Mail className="h-4 w-4 text-brand-orange" />
                <span className="text-xs text-text-secondary">Waleed Ahmad (Co-Founder):</span>
                <a
        ...
        {/* Bottom Bar */}
        <div className="mt-12 flex flex-col items-center justify-between border-t border-surface-border pt-6 sm:flex-row">
          <p className="text-xs text-text-secondary">
            © 2026 Entrpryz. All rights reserved.
          </p>
